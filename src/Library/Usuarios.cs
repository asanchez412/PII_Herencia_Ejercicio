...

{
    public class Usuarios
    {
        ...
        public void AddConductor (Conductor conductor)
        {
            ...
            Console.WriteLine(twitter.PublishToTwitter($"Tenemos un nuevo conductor! Bienvenid@ {conductor.Nombre} {conductor.Apellido}!",@"C:\Users\FIT\Desktop\Arreglos y combinaciones.png"));
        }
